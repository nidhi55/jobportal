                    ...
                    <div role="tabpanel" class="tab-pane active" id="recentjobs">
                	 ...
                	 ?>
                		...
                		<tr>
                            ...
                            <td>
                                 <a href="#"><img src="images/<?php echo $result1['photo']; ?>" class="img-responsive" alt="">
                                                </a>
                            </td>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <input type="text" id="uid2" name="uid"  >
          <input type="text" id="jid2" name="jid"  >
          <label>Meeting Date</label>
            <input type="text" class="form-control" name="md" id="datepicker">   </div>
        ...
        <div class="modal-footer">
            <button name="button" type="submit">Send</button>
                           ...
                           --><?php } 
                                ...
                                <button type="button" class="mj_btn mj_orangebtn" value="SELECTED">SELECTED
                               </button>
                            <?php }
                           ?>  
                        </form>
                		...
                		<td>
    						   <a class="mj_btn mj_orangebtn try" href="download.php?path=<?php echo $path; ?>">Resume</a><?php //echo $value['']; ?>             
                		</td>
                  	</tr>
