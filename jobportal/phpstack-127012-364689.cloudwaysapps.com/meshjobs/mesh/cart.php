            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mj_bottompadder50">
                    ...
                    <div class="cart_totals">
                        ...
                        <div class="mj_showmore"><a href="checkout.html" class="mj_showmorebtn mj_bigbtn mj_greenbtn">Proceed to Checkout</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-2 col-sm-offset-0 col-xs-offset-0">
                    <div class="mj_weight mj_bottompadder20">
                        <a href="#"><img src="images/logo.png" class="img-responsive" alt="">
                        </a>
