...
<!-- Mirrored from phpstack-127012-364689.cloudwaysapps.com/meshjobs/mesh/resume_preview.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Jan 2019 09:45:44 GMT -->
<head>
    <meta charset="utf-8" />
                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                    <div class="collapse navbar-collapse mj_navmenu" id="mj_menu">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="active"><a href="#">Post a Resume</a>
                                <ul class="sub_menu">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 col-lg-offset-3 col-md-offset-3">
                    <div class="mj_resume_heading">
                        ...
                        <h1>D<span>avid</span> S<span>impson</span></h1>
                        <ul>
                            <li>
                                <label><i class="fa fa-map-marker"></i>
                                </label>San Francisco</li>
                            <li>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="row">
                            <div class="mj_resume_changeing mj_yellowbg">
                                <a href="#"><i class="fa fa-angle-left"></i>Edit Resume</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
