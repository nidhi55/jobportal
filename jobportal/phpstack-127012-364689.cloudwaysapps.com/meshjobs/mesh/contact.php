                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-10 col-lg-offset-3 col-md-offset-3 col-sm-offset-3 col-xs-offset-1">
                            <div class="row">
                                <form class="mj_bottompadder80">
                                    ...
                                    <div class="form-group">
                                        <textarea placeholder="Message" class="form-control tr_textarea" id="msg" rows="7"></textarea>
                                    </div>
                                </form>
                            </div>
                        </div>
                        <div class="mj_showmore"><a href="#" class="mj_showmorebtn mj_bluebtn">send a message</a>
                        </div>
                    </div>
                </div>
            </div>
