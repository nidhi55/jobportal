...
?>
                                ...
                                <div class="card-body ">
                                    <div class="row p-b-20">
                                       <!-- <div class="col-md-6 col-sm-6 col-6">
                                            <div class="btn-group">
                                                <a href="insert_slider.php"><button id="sample_editable_1_new" class="btn btn-info"> Add New
                                    ...
                                    <table id="example1" class="display" style="width:100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="images-1/<?php echo $value['image']; ?>" height="50" width="50"></td>
                                                ...
                                                <td><a href="#"><button class="btn btn-danger btn-xs del22" value="<?php echo $value['id'] ?>">
                                                	...
                                                	<a href="slider_update.php?id=<?php echo $value['id'];?>"><button class="btn btn-primary btn-xs">
	...
	<script type="text/javascript">
        $('.del22').click(function(){
            ...
            {
                    widow.location.href="slider1.php";
            }
        })
    </script>
