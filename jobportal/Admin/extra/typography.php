...
<!-- Mirrored from radixtouch.in/templates/admin/smile/source/typography.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Mar 2019 09:49:05 GMT -->
<head>
    <meta charset="utf-8" />
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                                        ...
                                        <table class="table table-condensed table-borderless">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="type-info">Light 23px</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                ...
                                <div class="card-body ">
                                    <div class="row">
                                        <ul>
                                            ...
                                            <li>Fifth item
                                                <ul>
                                                    <li>fifth item first subitem</li>
                                                    <li>fifth item second subitem</li>
                                                    <li>fifth item third subitem</li>
                                                </ul>
                                            </li>
                                            <li>Sixth item</li>
                                            <li>Seventh item</li>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="text-purple">Lead Body</h2>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="text-purple">Highlighted Text</h2>
                        </div>
                        <div class="col-lg-3 col-md-4">
                            <div class="mg-bottom-xxl">
                                <p>
                        ...
                        <div class="offset-lg-1 col-md-8">
                            <div class="borderBox light bordered">
                                <p>Pellentesque habitant morbi tristique senectus et netus et malesuada
                                    <mark>fames ac turpis egestas</mark> libero sit amet quam egestas semper. Aenean ultricies mi.</p>
                                <p>
                                    <mark>Duis mollis, est non commodo luctus</mark>, nisi erat porttitor ligula, eget lacinia odio sem nec elit.
                                    <br/> This line of text is meant to be treated as fine print.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="text-purple">Bold Text</h2>
                        </div>
                        <div class="col-lg-3 col-md-4">
                            <div class="mg-bottom-xxl">
                                <p>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="text-purple">Deleted Text</h2>
                        </div>
                        <div class="col-lg-3 col-md-4">
                            <div class="mg-bottom-xxl">
                                <p>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="text-purple">Colored Text</h2>
                        </div>
                        <div class="col-lg-3 col-md-4">
                            <div class="mg-bottom-xxl">
                                <p>
                        ...
                        <div class="offset-lg-1 col-md-8">
                            <div class="borderBox light bordered">
                                <p class="txt-warning"> Aliquam tincidunt mauris eu risus. </p>
                                <p class="txt-error"> Lorem ipsum dolor sit amet. </p>
                                <p class="txt-info"> Pellentesque habitant morbi tristique. </p>
                                <p class="txt-success"> senectus et netus et malesuada fames ac turpis egestas. </p>
                                <p class="font-red"> Donec eu libero sit amet quam egestas semper. </p>
                                <p class="font-yellow"> Aenean ultricies mi vitae est. </p>
                                <p class="font-green"> Aliquam tincidunt mauris eu risus. </p>
...
<!-- Mirrored from radixtouch.in/templates/admin/smile/source/typography.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Mar 2019 09:49:07 GMT -->
</html>