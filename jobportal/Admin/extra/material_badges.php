...
<!-- Mirrored from radixtouch.in/templates/admin/smile/source/material_badges.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Mar 2019 09:49:33 GMT -->
<?php
include 'header.php';
?>
        <!-- end header -->
                ...
                <div class="page-content">
                    ...
                    <div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								<div class="card-head">
									<header>Number badge on icon </header>
								</div>
								<div class="card-body  row">
						            <div class="col-lg-2 p-t-20"> 
								        <div class="material-icons mdl-badge mdl-badge--overlap" data-badge="1">email</div>
						            </div>
						             <div class="col-lg-2 p-t-20"> 
						               <div class="material-icons mdl-badge mdl-badge--overlap" data-badge="2">call_missed</div>
						            </div>
						             <div class="col-lg-2 p-t-20"> 
						               <div class="material-icons mdl-badge mdl-badge--overlap" data-badge="3">message</div>
						            </div>
						             <div class="col-lg-2 p-t-20"> 
						               <div class="material-icons mdl-badge mdl-badge--overlap" data-badge="4">shopping_cart</div>
						            </div>
						             <div class="col-lg-2 p-t-20"> 
						               <div class="material-icons mdl-badge mdl-badge--overlap" data-badge="5">track_changes</div>
						            </div>
						             <div class="col-lg-2 p-t-20"> 
						               <div class="material-icons mdl-badge mdl-badge--overlap" data-badge="6">error_outline</div>
						            </div>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-12">
							<div class="card-box">
								<div class="card-head">
									<header>Icon badge on icon </header>
								</div>
								<div class="card-body  row">
						            <div class="col-lg-2 p-t-20"> 
								        <div class="material-icons mdl-badge mdl-badge--overlap" data-badge="♥">email</div>
						            </div>
						             <div class="col-lg-2 p-t-20"> 
						               <div class="material-icons mdl-badge mdl-badge--overlap" data-badge="♥">call_missed</div>
						            </div>
						             <div class="col-lg-2 p-t-20"> 
						               <div class="material-icons mdl-badge mdl-badge--overlap" data-badge="♥">message</div>
						            </div>
						             <div class="col-lg-2 p-t-20"> 
						               <div class="material-icons mdl-badge mdl-badge--overlap" data-badge="♥">shopping_cart</div>
						            </div>
						             <div class="col-lg-2 p-t-20"> 
						               <div class="material-icons mdl-badge mdl-badge--overlap" data-badge="♥">track_changes</div>
						            </div>
						             <div class="col-lg-2 p-t-20"> 
						               <div class="material-icons mdl-badge mdl-badge--overlap" data-badge="♥">error_outline</div>
						            </div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="card-box">
									<div class="card-head">
										<header>Number badge on Label </header>
									</div>
									<div class="card-body  row">
							            <div class="col-lg-2 p-t-20"> 
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="card-box">
									<div class="card-head">
										<header>Icon badge on Label </header>
									</div>
									<div class="card-body  row">
							            <div class="col-lg-2 p-t-20"> 
									         <a href="#">Emails</a>
