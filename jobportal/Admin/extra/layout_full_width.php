...
<!-- Mirrored from radixtouch.in/templates/admin/smile/source/layout_full_width.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Mar 2019 09:47:12 GMT -->
<head>
    <meta charset="utf-8" />
            ...
            <div class="navbar-custom">
				<div class="hor-menu hidden-sm hidden-xs">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="mega-menu-dropdown ">
                            <a href="#" class="dropdown-toggle"> <i class="material-icons">person</i>Professors
                                <i class="fa fa-angle-down"></i>
                                <span class="arrow "></span>
                            </a>
                            <ul class="dropdown-menu" style="min-width: 200px;">
                        ...
                        <li class="mega-menu-dropdown ">
                            <a href="#" class="dropdown-toggle"> <i class="material-icons">group</i>Students
                                <i class="fa fa-angle-down"></i>
                                <span class="arrow "></span>
                            </a>
                            <ul class="dropdown-menu" style="min-width: 200px;">
                        ...
                        <li class="mega-menu-dropdown ">
                            <a href="#" class="dropdown-toggle"> <i class="material-icons">school</i>Courses
                                <i class="fa fa-angle-down"></i>
                                <span class="arrow "></span>
                            </a>
                            <ul class="dropdown-menu" style="min-width: 200px;">
                        ...
                        <li class="mega-menu-dropdown ">
                            <a href="#" class="dropdown-toggle"> <i class="material-icons">local_library</i>Library
                                <i class="fa fa-angle-down"></i>
                                <span class="arrow "></span>
                            </a>
                            <ul class="dropdown-menu" style="min-width: 200px;">
                        ...
                        <li class="mega-menu-dropdown ">
                            <a href="#" class="dropdown-toggle"> <i class="material-icons">business</i>Departments
                                <i class="fa fa-angle-down"></i>
                                <span class="arrow "></span>
                            </a>
                            <ul class="dropdown-menu" style="min-width: 200px;">
                                            ...
                                            <div class="col-md-12">
                                                <ul class="mega-menu-submenu">
                                                   <li class="nav-item">
					                                ...
					                                <li class="nav-item">
					                                    <a href="add_fees.html" class="nav-link "> <span class="title">Add Payment</span>
					                                    </a>
					                                </li>
					                                <li class="nav-item">
					                                    <a href="invoice.html" class="nav-link "> <span class="title">Payment Invoice</span>
					                                    </a>
					                                </li>
                                                </ul>
                                            </div>
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Full Width Layout</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index.html">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li><a class="parent-item" href="#">Layouts</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
...
<!-- Mirrored from radixtouch.in/templates/admin/smile/source/layout_full_width.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Mar 2019 09:47:38 GMT -->
</html>