...
<!-- Mirrored from radixtouch.in/templates/admin/smile/source/tree.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Mar 2019 09:49:14 GMT -->
<head>
    <meta charset="utf-8" />
...
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white dark-sidebar-color logo-dark">
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Tree View</div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel">
                                <header class="panel-heading panel-heading-blue">
                                    Selectable Tree </header>
                                <div class="panel-body">
                                	<div class="row">
	                                    <div class="col-sm-4">
	                                        <h2>Input</h2>
	                                        <div class="form-group">
	                                            <label for="input-select-node" class="sr-only">Search Tree:
	                                            </label>
	                                            <input type="text" class="form-control" id="input-select-node" placeholder="Identify node..." value="Parent 1">
	                                        </div>
	                                        <div class="checkbox">
	                                            <label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel">
                                <header class="panel-heading panel-heading-purple">
                                    Expandible Tree </header>
                                <div class="panel-body">
                                	<div class="row">
	                                    <div class="col-sm-4">
	                                        <h2>Input</h2>
	                                        <div class="form-group">
	                                            <label for="input-expand-node" class="sr-only">Search Tree:
	                                            </label>
	                                            <input type="text" class="form-control" id="input-expand-node" placeholder="Identify node..." value="Parent 1">
	                                        </div>
	                                        <div class="checkbox">
	                                            <label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel">
                                <header class="panel-heading panel-heading-yellow">
                                    Checkable Tree</header>
                                <div class="panel-body">
                                	<div class="row">
	                                    <div class="col-sm-4">
	                                        <h2>Input</h2>
	                                        <div class="form-group">
	                                            <label for="input-check-node" class="sr-only">Search Tree:
	                                            </label>
	                                            <input type="text" class="form-control" id="input-check-node" placeholder="Identify node..." value="Parent 1">
	                                        </div>
	                                        <div class="checkbox">
	                                            <label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel">
                                <header class="panel-heading panel-heading-green">
                                    Disabled Tree</header>
                                <div class="panel-body">
                                	<div class="row">
	                                    <div class="col-sm-4">
	                                        <h2>Input</h2>
	                                        <div class="form-group">
	                                            <label for="input-disable-node" class="sr-only">Search Tree:
	                                            </label>
	                                            <input type="text" class="form-control" id="input-disable-node" placeholder="Identify node..." value="Parent 1">
	                                        </div>
	                                        <div class="checkbox">
	                                            <label>
    ...
    <script src="assets/js/pages/treeview/treeview-data.js" ></script>
    <!-- Common js-->
...
<!-- Mirrored from radixtouch.in/templates/admin/smile/source/tree.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Mar 2019 09:49:16 GMT -->
</html>