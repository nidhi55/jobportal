...
<!-- Mirrored from radixtouch.in/templates/admin/smile/source/advance_form.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Mar 2019 09:49:34 GMT -->
<?php
include 'header.php';
?>
        <!-- end header -->
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="card box">
                                ...
                                <div class="card-body" id="bar-parent">
                                    <form id="my-awesome-dropzone" action="http://radixtouch.in/target" class="dropzone form-horizontal"></form>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6">
                                    ...
                                    <form>
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6">
                                                ...
                                                <div class="radio">
                                                    <input id="radioCD1" name="radio3" type="radio" checked="checked" disabled="disabled">
                                                    <label for="radioCD1">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group spinner">
                                                        ...
                                                        <input type="number" class="form-control text-center" value="1" min="1" max="5"> <span class="input-group-btn">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group spinner">
                                                        ...
                                                        <input type="text" class="form-control text-center" value="1"> <span class="input-group-btn">
                                ...
                                <div class="card-body " id="bar-parent7">
                                    <form>
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="tags tags-input" data-type="tags" value="red,green,black,yellow" />
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Fruits:(fruits shown in aqua color)</label>
                                            <input type="text" class="tags tags-input" data-type="fruits-tags" data-highlight-color="#00C0EF" value="apple,red,black,banana" />
                                        </div>
                                        <div class="form-group">
...
<!-- Mirrored from radixtouch.in/templates/admin/smile/source/advance_form.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Mar 2019 09:49:56 GMT -->
</html>