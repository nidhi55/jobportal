...
<!-- Mirrored from radixtouch.in/templates/admin/smile/source/material_tables.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Mar 2019 09:49:33 GMT -->
<?php
include 'header.php';
?>
        <!-- end header -->
                    ...
                    <div class="page-bar">
										...
										<table class="mdl-data-table mdl-js-data-table mdl-data-table--selectable mdl-shadow--2dp">
										  ...
										  <tbody>
										    <tr>
										      ...
										      <td class="mdl-data-table__cell--non-numeric">Gandhi road, Ahmedabad</td>
										      <td>25</td>
										      <td>$1.00</td>
										      <td>$0.90</td>
										      <td>$12.90</td>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="card-box">
									<div class="card-head">
										<header>Bordered and Striped table</header>
									</div>
									<div class="card-body ">
