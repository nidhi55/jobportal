...
<!-- Mirrored from radixtouch.in/templates/admin/smile/source/material_icons.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Mar 2019 09:50:59 GMT -->
<?php
include 'header.php';
?>
        <!-- end header -->
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Material Icons</div>
                            </div>
								...
								<div class="card-box">
									<div class="card-body ">
										<div class="mdl-grid icon-set">
										    ...
										    <div class="mdl-cell mdl-cell--12-col">
										      <h3 class="no-m-b">Communication</h3>
										    </div>
										    <div class="mdl-cell mdl-cell--3-col mdl-cell--4-col-tablet">
										      <div class="icon-holder">
