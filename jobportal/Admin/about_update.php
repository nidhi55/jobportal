                        ...
                        <div class="col-md-12 col-sm-12 col-lg-12">
                            <div class="card card-box">
                                ...
                                <div class="card-body " id="bar-parent">
                                    <form method="post" action="aboutupdate.php" enctype="multipart/form-data">
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"  value="<?php echo $result[1]; ?>" name="content">
                                        </div>
                                         <div class="form-group">
                                            <label for="simpleFormPassword">SubContent</label>
                                            <textarea class="form-control"  name="subcontent">
                                            <?php echo $result[2];?>
                                            </textarea>
                                        </div>
                                       <div class="form-group">
                                            <label for="simpleForImage">Video</label><br>
