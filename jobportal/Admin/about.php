...
?>
                                    ...
                                    <table id="example1" class="display" style="width:100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $value['subcontent'];  ?></td>
                                                <td><?php echo $value['video']; ?></td>
                                                <td><a href="about_update.php?id=<?php echo $value['id'] ?>"><button class="btn btn-danger btn-xs" value="<?php echo $value['id'] ?>">
    ...
    <script type="text/javascript">
        $('.del22').click(function(){
            ...
            {
                    widow.location.href="post_job.php";
            }
        })
    </script>
