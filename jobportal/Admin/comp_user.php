...
?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-topline-aqua">
                                <div class="card-head">
                                    <header>COMPANY_USER TABLE</header>
                                    <div class="tools">
                                  ...
                                  <div class="table-scrollable">
                                    <table id="example1" class="display" style="width:100%;">
                                        ...
                                        <tbody>
                                            ...
                                            { ?>
                                            <tr>
                                                <td><img src="../images/users/<?php echo $value['logo']; ?>" height="50" width="50"></td>
                                                <td><?php echo $value['comp_nm'];  ?></td>
                                                ...
                                                <td><a href="#"><button class="btn btn-danger btn-xs del22" value="<?php echo $value['id'] ?>">
                                                    ...
                                                    if ($a==$value['block_st']) {
                                                     ?>    
                                                    <a href="block_comp.php?id=<?php echo $value['id']; ?>"><button class="btn btn-primary btn-xs" value="<?php echo $value['id'] ?>">
                                                        <!--<i class="fa fa-ban"></i>-->
                                                        Block
                                                    </button></a>
                                                    <?php }else{ ?>
                                                        <a href="unblock_comp.php?id=<?php echo $value['id']; ?>"><button class="btn btn-primary btn-xs" value="<?php echo $value['id'] ?>">
                                                        <!--<i class="fa fa-ban"></i>-->
                                                        UnBlock
                                                    </button></a>
                                                    <?php }?>
	...
	<script type="text/javascript">
        $('.del22').click(function(){
            ...
            {
                var id=$(this).val();
                window.location.href = "delete_compuser.php?id="+id;
            }
            else
            {
                    widow.location.href="comp_user.php";
            }
        })
    </script> 
    <!-- end js include path -->
