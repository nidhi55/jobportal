                        ...
                        <div class="col-md-12 col-sm-12 col-lg-12">
                            <div class="card card-box">
                                ...
                                <div class="card-body " id="bar-parent">
                                    <form method="post" action="siderupdate.php" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <label for="simpleFormPassword">Heading</label>
                                            <input type="text" class="form-control"  value="<?php echo $result[2]; ?>" name="heading">
                                        </div>
                                         <div class="form-group">
                                            <label for="simpleFormPassword">SubHeading</label>
                                            <input type="text" class="form-control" value="<?php echo $result[3];?>" name="subheading">
                                        </div>
