                        ...
                        <div class="col-md-12 col-sm-12 col-lg-12">
                            <div class="card card-box">
                                ...
                                <div class="card-body " id="bar-parent">
                                    <form method="post" action="testupdate.php" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="simpleFormEmail">Id</label>
                                            <input type="text" class="form-control" value="<?php echo $id; ?>" disabled="true">
                                        </div>
                                        <div class="form-group">
                                            <label for="simpleForImage">Image</label><br>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"  value="<?php echo $result[2]; ?>" name="desc">
                                        </div>
                                         <div class="form-group">
                                            <label for="simpleFormPassword">Name</label>
                                            <input type="text" class="form-control" value="<?php echo $result[3];?>" name="name">
                                        </div>
                                        <div class="form-group">
                                            <label for="simpleFormPassword">CompanyName</label>
                                            <input type="text" class="form-control" value="<?php echo $result[4];?>" name="cname">
                                        </div>
